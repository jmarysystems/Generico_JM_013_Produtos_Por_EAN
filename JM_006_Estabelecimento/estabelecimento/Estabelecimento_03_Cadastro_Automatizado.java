 ...
 * @author AnaMariana
 */
public class Estabelecimento_03_Cadastro_Automatizado extends javax.swing.JPanel {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////     
     ...
     * @param Home2 */
    public Estabelecimento_03_Cadastro_Automatizado( Home Home2 ) {
        initComponents();
    ...
    public DefaultTableModel                tmPesquisa = new DefaultTableModel( null, new String[]{ 
                "ID", "CÓDIGO", "NOME", "EMAIL", "ACESSO AO SISTEMA", "DATA CADASTRO", "DATA ÚLTIMA ALTERACAO", "DATA ULTIMA ALTERACAO SENHA"           
            } );
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////             
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Estabelecimento - Cadastro Automatizado");
    ...
    if( tbPesquisa.getModel().getRowCount() > 0 ){
        try{        
            ...
            for( int L_i=0; L_i < tbPesquisa.getRowCount(); L_i++ ){
                ...
                Estabelecimento UsuarioSistema = new Estabelecimento();
                    ...
                    switch( C_i ){
                        ...
                        case 0: 
                            try{
                                ...
                                UsuarioSistema.setId(idCadastroUsuario);
                        ...
                        case 1: 
                            try{
                                ...
                                UsuarioSistema.setCodigoAuxiliar(str);
                        ...
                        case 4: 
                            try{
                                ...
                                UsuarioSistema.setEmailRecuperacao(str);
                        ...
                        case 5: 
                            try{
                                ...
                                UsuarioSistema.setPermitirAcessoAoSistema(str);
                        ...
                        case 6: 
                            try{
                                ...
                                ////////dd.MM.yyyy HH:mm:ss/////////////EEEE, d MMMM yyyy HH:mm:ss
                                ////////
                                String dataDigitadaNoTF = str.trim();
                                java.util.Date data = dfmt.parse( dataDigitadaNoTF ); 
                                java.sql.Timestamp data_Timestamp = new java.sql.Timestamp(data.getTime()); 
                                // STRING PARA DATA //////////////////////////////////////////////////////////////
                                UsuarioSistema.setDataCadastro(data_Timestamp);
                        ...
                        case 7: 
                            try{
                                ...
                                ////////
                                String dataDigitadaNoTF = str.trim();
                                Date data = dfmt.parse( dataDigitadaNoTF ); 
                                java.sql.Timestamp data_Timestamp = new java.sql.Timestamp(data.getTime());
                                // STRING PARA DATA ///////////////////////////////////////////////////////////////
                                UsuarioSistema.setDataAlteracao(data_Timestamp);
                        ...
                        case 8: 
                            try{
                                ...
                                java.sql.Timestamp data_Timestamp = new java.sql.Timestamp(data.getTime());
                                // STRING PARA DATA //////////////////////////////////////////////////////////////
                                UsuarioSistema.setDataUltimaAlteracaoSenha(data_Timestamp);
                        ...
                        case 9: 
                            try{
                                ...
                                Estabelecimento UsuarioSistema2 = new Estabelecimento();
                                String x = str.replace(".", "");
                                String x2 = x.replace(",", ".");
                                int idCadastroUsuario = 0; try{ idCadastroUsuario = Integer.parseInt(x2); } catch( Exception e ){}
                                UsuarioSistema2.setId(idCadastroUsuario);                   
                                
                                UsuarioSistema.setIdUsuarioSistemaCadastro(UsuarioSistema2);
                        ...
                        case 10: 
                            try{
                                ...
                                String x = str.replace(".", "");
                                String x2 = x.replace(",", ".");
                                int idAlteracaoUsuario = 0; try{ idAlteracaoUsuario = Integer.parseInt(x2); } catch( Exception e ){}
                                UsuarioSistema2.setId(idAlteracaoUsuario);
                                
                                UsuarioSistema.setIdUsuarioSistemaAlteracao(UsuarioSistema2);
...
/////// VERIFICANDO REPETIÇÃO - CÓDIGO AUXILIAR /////////////////////////////////////////////////////////////////////////////////////////////////////////
                    Query q2 = JPAUtil.em().createNativeQuery("SELECT * FROM JM.USUARIO_SISTEMA WHERE CODIGO_AUXILIAR = ?", Estabelecimento.class );
                    q2.setParameter( 1, UsuarioSistema.getCodigoAuxiliar() ); 
                    List<Estabelecimento> list = q2.getResultList();
                    
                    boolean material_ja_Cadastrado = false;
                    for (Estabelecimento list1 : list) {
                        
                        if (list1.getCodigoAuxiliar().equals( UsuarioSistema.getCodigoAuxiliar() )) {
                            ...
                            if( tipoCadastro.equals("Cadastrar e Alterar") ){
                                ...
                                list1.setLogin(UsuarioSistema.getLogin());
                                
                                DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( list1, JPAUtil.em());
                                Estabelecimento UsuarioSistema_Cadastrado = (Estabelecimento) DAOGenericoJPA2.gravanovoOUatualizar();
                            }
                            /////// ALTERANDO ITEM JÁ CADASTRADO - COM DADOS DO ITEM QUE IRIA SER CADASTRADO ///////////////////////
                            
                            //System.out.println( "Material Já Cadastrado - " + Estabelecimento.getCodigoAuxiliar() );
                            
                            String txt = ListaSAPNaoCadastrado.tpListSap.getText();
                            ListaSAPNaoCadastrado.tpListSap.setText( txt+"\n"+UsuarioSistema.getCodigoAuxiliar() );
                            break;                            
                        }
                    }
/////// VERIFICANDO REPETIÇÃO - CÓDIGO AUXILIAR ////////////////////////////////////////////////////////////////////////////////////////////////////////
                    if ( material_ja_Cadastrado == false ) {
                        ...
                        DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( UsuarioSistema, JPAUtil.em());
                        Estabelecimento UsuarioSistema_Cadastrado = (Estabelecimento) DAOGenericoJPA2.gravanovoOUatualizar();
                    }
            ...
            switch(opcao){
                ...
                case 1:
                    ...
                    tmPesquisa = new DefaultTableModel( null, new String[]{ 
                        "ID", "CÓDIGOAUX", "NOME", "SENHA", "EMAIL", "ACESSO AO SISTEMA", "DATA CADASTRO", "DATA ÚLTIMA ALTERACAO", 
                        "DATA ULTIMA ALTERACAO SENHA", "USUÁRIO QUE CADASTROU", "ULTIMO USUÁRIO QUE ALTEROU" } );
                    tbPesquisa.setModel(tmPesquisa);
                break;    
        ...
        try{
            ...
            switch(opcao){
                ...
                case 1:
                    ...
                    tbPesquisa.getColumnModel().getColumn(count).setPreferredWidth(50);
                    ...
                    tbPesquisa.getColumnModel().getColumn(count).setPreferredWidth(125);
                    tbPesquisa.getColumnModel().getColumn(count).setResizable(true);
                    tbPesquisa.getColumnModel().getColumn(count).setCellRenderer( rendererCentro );
                    count++;
            
                    tbPesquisa.getColumnModel().getColumn(count).setPreferredWidth(290);
                    tbPesquisa.getColumnModel().getColumn(count).setResizable(true);
                    count++;
                    ...
                    tbPesquisa.getColumnModel().getColumn(count).setPreferredWidth(40);
                    tbPesquisa.getColumnModel().getColumn(count).setResizable(true);
                    count++;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            try {
                                List<UsuarioSistema> Estabelecimento = null;
                                try{ 
                                    Query q = JPAUtil.em().createNativeQuery("SELECT * FROM JM.USUARIO_SISTEMA WHERE ID = '"+material_procurado+"'", Estabelecimento.class );
                                    Estabelecimento = q.getResultList();
                                }catch( Exception e ){ }
                                
                                String rbusca = ""; try{ rbusca = String.valueOf( Estabelecimento.get(0).getId() ); }catch( Exception e ){}
                                
                                if( !rbusca.equals("") ){
                                    SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
                                    
                                    try{ id                            = Estabelecimento.get(0).getId();                                           }catch( Exception e ){}
                                    try{ nome                          = Estabelecimento.get(0).getNome();                                         }catch( Exception e ){}
                                    try{ senha                         = Estabelecimento.get(0).getSenha();                                        }catch( Exception e ){}
                                    try{ email                         = Estabelecimento.get(0).getEmailRecuperacao();                             }catch( Exception e ){}
                                    try{ acesso_ao_sistema             = Estabelecimento.get(0).getPermitirAcessoAoSistema();                      }catch( Exception e ){}                                    
                                    try{ data_cadastro                 = formatter.format( Estabelecimento.get(0).getDataCadastro() );             }catch( Exception e ){}                                    
                                    try{ data_ultima_alteracao         = formatter.format( Estabelecimento.get(0).getDataUltimaAlteracaoSenha());  }catch( Exception e ){}
                                    try{ data_ultima_alteracao_senha   = formatter.format( Estabelecimento.get(0).getDataUltimaAlteracaoSenha());  }catch( Exception e ){}
                                    try{ id_usuario_que_cadastrou      = Estabelecimento.get(0).getIdUsuarioSistemaCadastro(); }catch( Exception e ){}
                                    try{ id_usuario_que_alterou        = Estabelecimento.get(0).getIdUsuarioSistemaAlteracao(); }catch( Exception e ){}
                                }
                            }catch( Exception e ){}
                            */
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
