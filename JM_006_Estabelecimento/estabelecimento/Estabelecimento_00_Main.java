...
import estabelecimento_menu_e_submenu.Estabelecimento_Menu_01;
 ...
 * @author NewUser
 */
public class Estabelecimento_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Estabelecimento_Menu_01( Home ).Barra_Menu );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Estabelecimento_00_Main();
        applet.init();
