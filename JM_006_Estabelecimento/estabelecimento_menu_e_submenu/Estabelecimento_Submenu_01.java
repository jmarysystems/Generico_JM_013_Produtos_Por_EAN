...
import estabelecimento.Estabelecimento_01_Indice;

/**
 *
 * @author ana
 */
public class Estabelecimento_Submenu_01 extends javax.swing.JPanel {

    Home Home;
        
    public Estabelecimento_Submenu_01( Home Home2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios5.setText("Estabelecimento");
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Usuários do Sistema Índice", "livroTp.gif", new Estabelecimento_01_Indice(Home) ); 
