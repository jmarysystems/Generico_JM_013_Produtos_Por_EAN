 ...
 * @author Ana
 */
public class Estabelecimento_Imprimir_03_Imprimindo extends Thread { 
    ...
    public Estabelecimento_Imprimir_03_Imprimindo( List<File> lista_Arquivos2  ){   
    ...
    public void impressora(){  
        synchronized(this) { 
            ...
            Estabelecimento_Imprimir_04_Impressora Impressora = new Estabelecimento_Imprimir_04_Impressora( "" );
    ...
    public void imprimirComPropriedadesEConfigurações() { 
        ...
        */
        ...
        synchronized(this) {
            ...
            synchronized(this) {
                Printable pTable  = new Estabelecimento_Imprimir_05_PrintX_JM( htmlPanePrincipal, PrinterJob, aset );    
