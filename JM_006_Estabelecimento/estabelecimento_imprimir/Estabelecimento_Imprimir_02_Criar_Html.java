 ...
 * @author Ana
 */
public class Estabelecimento_Imprimir_02_Criar_Html { 
    ...
    public Estabelecimento_Imprimir_02_Criar_Html( String pagina2, int qtdLinha2, int numeroPagina2, int qtd_linhas_por_pg ) {  
