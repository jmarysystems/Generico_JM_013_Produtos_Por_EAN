 ...
 * @author i
 */
public class Estabelecimento_Imprimir_05_PrintX_JM implements Printable {
    PrinterJob pJob2;
    ...
    public Estabelecimento_Imprimir_05_PrintX_JM( JEditorPane pane, PrinterJob pJob, PrintRequestAttributeSet aset ) { try { 
