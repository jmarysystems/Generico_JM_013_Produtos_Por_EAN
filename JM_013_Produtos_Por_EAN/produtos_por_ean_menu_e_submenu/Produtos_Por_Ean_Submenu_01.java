...
import produtos_por_ean.Produtos_Por_Ean_01_Indice;

/**
 *
 * @author ana
 */
public class Produtos_Por_Ean_Submenu_01 extends javax.swing.JPanel {

    Home Home;
        
    public Produtos_Por_Ean_Submenu_01( Home Home2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios5.setText("Produtos Por Ean");
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Produtos Por Ean Índice", "livroTp.gif", new Produtos_Por_Ean_01_Indice(Home) ); 
