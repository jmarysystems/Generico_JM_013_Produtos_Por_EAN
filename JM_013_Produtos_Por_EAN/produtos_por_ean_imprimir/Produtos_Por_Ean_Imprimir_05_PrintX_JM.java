 ...
 * @author i
 */
public class Produtos_Por_Ean_Imprimir_05_PrintX_JM implements Printable {
    PrinterJob pJob2;
    ...
    public Produtos_Por_Ean_Imprimir_05_PrintX_JM( JEditorPane pane, PrinterJob pJob, PrintRequestAttributeSet aset ) { try { 
