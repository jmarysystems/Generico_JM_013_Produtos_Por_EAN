 ...
 */
package produtos_por_ean_visualizador_imagens_banco_de_dados;
...
import produtos_por_ean.Banco_Ctrl_Tabela_BD;
import produtos_por_ean.Produtos_Por_Ean_02_Cadastrar_Visualizar;
 ...
 * @author admin
 */
public class Produtos_Por_Ean_Visualizador_De_Imagens extends javax.swing.JPanel {
         
    Home Home;
    ProdutosPorEan Classe_Bean_Recebida;
    int id_Da_Classe_Recebida;
    Produtos_Por_Ean_02_Cadastrar_Visualizar Tabela_Recebida_02_Cadastrar_Visualizar = null;
    ...
    //////////////////////////////
    int int_Da_Tabela_Recebida_Imagens_Lista = 0;
    int qtdArquivos = 0;
    int id_imagem = 0;
    //////////////////////////////
     ...
     * @param Home2
     * @param Classe_Bean_Recebida2
     * @param status_cadastro2
     * @param Tabela_Recebida_02_Cadastrar_Visualizar2
     */
    public Produtos_Por_Ean_Visualizador_De_Imagens( Home Home2, ProdutosPorEan Classe_Bean_Recebida2, String status_cadastro2, 
            Produtos_Por_Ean_02_Cadastrar_Visualizar Tabela_Recebida_02_Cadastrar_Visualizar2 ){
        initComponents();
        
        Home = Home2;        
        Classe_Bean_Recebida = Classe_Bean_Recebida2;
        status_cadastro = status_cadastro2;
        Tabela_Recebida_02_Cadastrar_Visualizar = Tabela_Recebida_02_Cadastrar_Visualizar2;                  
    ...
    private void setar_Dados_Iniciais(){
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if(status_cadastro.equalsIgnoreCase("Cadastrando...")){
                ...
                id_Da_Classe_Recebida = 0;
            }
            else if(status_cadastro.equalsIgnoreCase("Visualizando...")){
                
                id_Da_Classe_Recebida = Classe_Bean_Recebida.getId();

                if( id_Da_Classe_Recebida > 0 ){
                    setarImagemInicio();
                }
    ...
    new Thread() {   @Override public void run() { try { 
        ...
        List<ProdutosPorEanImagens> Classe_Imagens_Da_Tabela_Recebida = null;
        try{ 
            ...
            q.setParameter(1, id_Da_Classe_Recebida );
            List<ProdutosPorEanImagens> lista_Banco = q.getResultList();   
            Classe_Imagens_Da_Tabela_Recebida = lista_Banco;
        }catch( Exception e ){ }
        
        String rbusca = ""; 
        try{ rbusca = Classe_Imagens_Da_Tabela_Recebida.get(0).getNome(); }catch( Exception e ){}
	    ...
	    BufferedImage bufImg = null;
            ...
            try{
                ...
                bufImg = ImageIO.read(new ByteArrayInputStream( (byte[]) Classe_Imagens_Da_Tabela_Recebida.get(int_Da_Tabela_Recebida_Imagens_Lista).getImagem())); //ImageIO.read( img );
	    ...
	    try{
                ...
                ///////////////////////////////////////////
                id_imagem = Classe_Imagens_Da_Tabela_Recebida.get(int_Da_Tabela_Recebida_Imagens_Lista).getId();
                qtdArquivos = Classe_Imagens_Da_Tabela_Recebida.size();
                System.out.println("qtdArquivos: " + qtdArquivos);
                System.out.println("int_Estabelecimento_Imagens_Lista: " + int_Da_Tabela_Recebida_Imagens_Lista);
    ...
    private void initComponents() {
        ...
        pesquisarImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/home_controle_menus_norte/imagens/conexao.png"))); // NOI18N
        pesquisarImagem.setToolTipText("ADICIONAR IMAGEM");
    ...
    private void jLabel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MousePressed
        int_Da_Tabela_Recebida_Imagens_Lista++;
    ...
    private void lbHomeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbHomeMousePressed
        int_Da_Tabela_Recebida_Imagens_Lista=0;
    ...
    private void setarImagem_da_Lista(){ 
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
                ...
                if( (int_Da_Tabela_Recebida_Imagens_Lista < qtdArquivos) && (int_Da_Tabela_Recebida_Imagens_Lista >= 0) ){
                    ...
                    try{
                        ...
                        List<ProdutosPorEanImagens> Tabela_Atual_Imagens = null;                        
                        try{ 
                            Query q = JPAUtil.em().createNativeQuery("SELECT * FROM " + Banco_Ctrl_Tabela_BD.get_imagem() + " WHERE ID_PRODUTOS_POR_EAN_PRODUTOS_POR_EAN_IMAGENS = ?", ProdutosPorEanImagens.class );
                            q.setParameter(1, id_Da_Classe_Recebida );
                            List<ProdutosPorEanImagens> lista_Banco = q.getResultList();   
                            Tabela_Atual_Imagens = lista_Banco;
                        }catch( Exception e ){ }
                        
                        id_imagem = Tabela_Atual_Imagens.get(int_Da_Tabela_Recebida_Imagens_Lista).getId();
                
                        bufImg = ImageIO.read(new ByteArrayInputStream( (byte[]) Tabela_Atual_Imagens.get(int_Da_Tabela_Recebida_Imagens_Lista).getImagem())); //ImageIO.read( img );
                        icon   = new ImageIcon(bufImg);
                        image  = icon.getImage();//ImageIO.read(f);  
                    } catch (Exception ex) {} 
	            ...
	            try{
                        ...
                        System.out.println("setarImagem_da_Lista 1 - int_UsuarioImagens_Lista: " + int_Da_Tabela_Recebida_Imagens_Lista);
                        
                    }catch(Exception ex){}
                }
                else{   
                    
                    if( int_Da_Tabela_Recebida_Imagens_Lista <= 0){
                        int qtd_Arquivos_da_Pasta = qtdArquivos-1;
                        int_Da_Tabela_Recebida_Imagens_Lista = qtd_Arquivos_da_Pasta;
                    }
                    else{
                        int_Da_Tabela_Recebida_Imagens_Lista = 0;
                    }
                    ...
                    try{
                        ...
                        List<ProdutosPorEanImagens> EstabelecimentoImagens = null;                        
                        try{ 
                            Query q = JPAUtil.em().createNativeQuery("SELECT * FROM " + Banco_Ctrl_Tabela_BD.get_imagem() + " WHERE ID_PRODUTOS_POR_EAN_PRODUTOS_POR_EAN_IMAGENS = ?", ProdutosPorEanImagens.class );
                            q.setParameter(1, id_Da_Classe_Recebida );
                            List<ProdutosPorEanImagens> lista_Banco = q.getResultList();   
                        ...
                        id_imagem = EstabelecimentoImagens.get(int_Da_Tabela_Recebida_Imagens_Lista).getId();
                        
                        bufImg = ImageIO.read(new ByteArrayInputStream( (byte[]) EstabelecimentoImagens.get(int_Da_Tabela_Recebida_Imagens_Lista).getImagem())); //ImageIO.read( img );
                        icon   = new ImageIcon(bufImg);
                        image  = icon.getImage();//ImageIO.read(f);  
                    } catch (Exception ex) {}  
                    ...
                    try {  
                        ...
                        System.out.println("setarImagem_da_Lista 2 - int_UsuarioImagens_Lista: " + int_Da_Tabela_Recebida_Imagens_Lista);
                    }catch(Exception ex){}
                }
    ...
    private void pesquisarImagemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pesquisarImagemMousePressed
        if( pesquisarImagem.isEnabled() ){
            ...
            new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
                ...
                try{ escolherImagem_Externa(); } catch( Exception e ){ }
            ...
            if( lbExcluir.isEnabled() ){
                try{
                    ...
                    Exportando.pbg.setValue( 50 );                    
                     ...
                     List<ProdutosPorEanImagens> Lista_De_Imagens_Para_Excluir = null;
                    try{ 
                        Query q = JPAUtil.em().createNativeQuery("SELECT * FROM " + Banco_Ctrl_Tabela_BD.get_imagem() + " WHERE ID_PRODUTOS_POR_EAN_PRODUTOS_POR_EAN_IMAGENS = ? AND ID = ?", ProdutosPorEanImagens.class );
                        q.setParameter(1, id_Da_Classe_Recebida );
                        q.setParameter( 2, id_imagem );
                        
                        Lista_De_Imagens_Para_Excluir = q.getResultList();   
                    }catch( Exception e ){ }
        
                    String rbusca = ""; 
                    try{ rbusca = Lista_De_Imagens_Para_Excluir.get(0).getNome(); }catch( Exception e ){}
            
                    if( !rbusca.equals("") ){
            
                        DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( Lista_De_Imagens_Para_Excluir.get(0), JPAUtil.em());
        ...
        if( btSalvar.isEnabled() ){
            ...
            new Thread() {   @Override public void run() { try { 
                ...
                if(status_cadastro.equalsIgnoreCase("Cadastrando...")){
                    ...
                    try{ Tabela_Recebida_02_Cadastrar_Visualizar.lista_de_Endereco_imagemExterna_.add( imagemExterna_Endereco.getPath() ); } catch( Exception e ){} 
                    try{ 
                        
                        File img = new File( imagemExterna_Endereco.getPath() );
                        Tabela_Recebida_02_Cadastrar_Visualizar.setarImagemExterna_Endereco_for( img ); 
                    } catch( Exception e ){}
    ...
    private void escolherImagem_Externa() {                                      
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            if (!strdevolvida.isEmpty()){
                
                if (strdevolvida.length() > 6) {
                    
                    strdevolvida = strdevolvida.substring (6);
                }  
            }
            System.out.println(strdevolvida);
    ...
    private void salvar(){ 
        ...
        try { 
            ...
            try{
                ...
                ProdutosPorEanImagens Classe_Imagens_Recebida = new ProdutosPorEanImagens();
                ...
                Classe_Imagens_Recebida.setImagem(byteArray);
                
                try{ Classe_Imagens_Recebida.setId( Classe_Bean_Recebida.getId() ); }catch( Exception e ){}
                try{ Classe_Imagens_Recebida.setNome( nomeList[0] ); }catch( Exception e ){}
                
                try{
                    DAOGenericoJPA DAOGenericoJPA2 = new DAOGenericoJPA( Classe_Imagens_Recebida, JPAUtil.em());
                    ProdutosPorEanImagens EstabelecimentoImagens_Cadastrado = (ProdutosPorEanImagens) DAOGenericoJPA2.gravanovoOUatualizar();
                    ...
                    try{ 
                        ...
                        System.out.println("atual - int_UsuarioImagens_Lista: " + int_Da_Tabela_Recebida_Imagens_Lista);
